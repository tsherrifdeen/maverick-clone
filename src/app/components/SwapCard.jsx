    ...
    <>
      <div className="p-5 mx-auto mt-20 bg-gray-300 border border-gray-100 shadow-sm border-opacity-20 bg-opacity-5 w-96 rounded-2xl backdrop-filter backdrop-blur-lg">
        ...
        <div className="flex items-center justify-between w-full p-3 my-3 bg-gray-200 border border-gray-100 border-opacity-20 bg-opacity-5 rounded-3xl backdrop-filter backdrop-blur-lg">
          <button className="flex px-3 py-2 bg-gray-200 rounded-lg bg-opacity-10 backdrop-filter backdrop-blur-lg">
            <h6>Add Token</h6>
            <svg
        ...
        <div className="flex items-center justify-between w-full p-3 my-3 bg-gray-100 border border-gray-100 rounded-3xl border-opacity-20 bg-opacity-5 backdrop-filter backdrop-blur-lg">
          <button className="flex px-3 py-2 bg-gray-100 rounded-lg bg-opacity-10 backdrop-filter backdrop-blur-lg">
            <h6>Add Token</h6>
            <svg
              className="w-8 h-6 m-0 text-white"
              focusable="false"
        ...
        <button className="w-full px-4 py-3 text-white rounded-lg bg-violet-800">
